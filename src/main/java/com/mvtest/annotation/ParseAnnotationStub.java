...
public class ParseAnnotationStub {
	...
	public String parseMethod(Class<?> clazz,Object t) throws IllegalArgumentException,
	    ...
	    for(Field filed: clazz.getDeclaredFields()){
	    	HelloWorldAnnotation hello = filed.getAnnotation(HelloWorldAnnotation.class);
	    	if(hello!=null){
	    		String str = hello.name();
	    		filed.setAccessible(true);
	    		Class typeClass = filed.getType();  
	            Constructor con = typeClass.getConstructor();  
	            Object insertObj = con.newInstance();  
	    		filed.set(t, insertObj);
	    	}
	    }
		//变量该对象的方法
		for (Method method : clazz.getDeclaredMethods()) {
			...
			if (say != null) {
				...
				TypeVariable<Method>[] gd = method.getTypeParameters();
